...
namespace FluentCommunity\Framework\Support\Polyfills\MBString;
 ...
 * not installed.
 *
 * Everything for this polyfill lives under Support/Polyfills/: this class
 * and the Unicode tables (unidata/) in the MBString/ folder, plus the global
 * mb_* wrappers in mbstring.php beside it. Deleting that file and folder
 * cleanly removes mbstring fallback support; the autoload shim
 * Polyfills/loader.php then skips them as a harmless no-op.
 *
 ...
 *
 * The thin global mb_* wrappers live in ../mbstring.php and only delegate

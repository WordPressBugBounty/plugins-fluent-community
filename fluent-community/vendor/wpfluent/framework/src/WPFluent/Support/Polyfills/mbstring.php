 ...
 *
 * Implementations live in FluentCommunity\Framework\Support\Polyfills\MBString\Mbstring. Case
 * helpers do full Unicode simple case mapping via the bundled tables in
 * MBString/unidata/ (vendored from symfony/Unicode); see that class's
 * docblock for scope and limits.
 *
 * Loaded via the Polyfills/loader.php autoload shim. To drop mbstring
 * fallback support, delete this file and the MBString/ folder.
 */

use FluentCommunity\Framework\Support\Polyfills\MBString\Mbstring;

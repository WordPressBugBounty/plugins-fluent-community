                        ...
                        <?php if (!defined('FLUENT_COMMUNITY_PRO')): ?>
                            <a title="Upgrade to Pro" target="_blank" rel="noopener" class="fcom_inline_icon_link_item"
                               href="<?php echo esc_url(Utility::getProductUrl(true)) ?>">
                                <span class="el-icon">
                                    <svg width="126" height="125" viewBox="0 0 126 125" fill="none"><rect x="0.22139" width="125" height="125" rx="17.8571" fill="#4A5FE0"/>
                                        <path d="M47.9424 75.1832L61.6888 67.2467L69.6253 80.9931C62.0334 85.3763 52.3256 82.7751 47.9424 75.1832Z" fill="white"/>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M75.4348 59.3101L61.6884 67.2466L69.6249 80.993L83.3713 73.0565L75.4348 59.3101ZM89.1821 51.3734L75.4356 59.3099L83.3721 73.0564L97.1186 65.1199L89.1821 51.3734Z" fill="white"/>
                                        <path d="M89.182 51.3736C92.978 49.182 97.8319 50.4826 100.023 54.2786L103.992 61.1518L97.1185 65.12L89.182 51.3736Z" fill="white"/>
                                        <path d="M64.593 56.4052L50.8466 64.3417L42.9101 50.5953L56.6565 42.6588L64.593 56.4052Z" fill="white"/>
                                        <path d="M78.3397 48.4683L64.5933 56.4048L56.6568 42.6584C64.2487 38.2752 73.9565 40.8764 78.3397 48.4683Z" fill="white"/>
                                        <path d="M50.847 64.3418L37.1006 72.2783L29.1641 58.5318L42.9105 50.5953L50.847 64.3418Z" fill="white"/>
                                        <path d="M37.1011 72.2783C33.3051 74.4699 28.4512 73.1693 26.2596 69.3733L22.2913 62.5001L29.1646 58.5319L37.1011 72.2783Z" fill="white"/>
                                    </svg>
                                </span>
                               ...
                               href="<?php echo esc_url(admin_url()); ?>">
                                <span class="el-icon">
                                    <svg viewBox="0 0 122.52 122.523"><g fill="currentColor">
                                        ...
                                        <path d="m61.262 0c-33.779 0-61.262 27.481-61.262 61.26 0 33.783 27.483 61.263 61.262 61.263 33.778 0 61.265-27.48 61.265-61.263-.001-33.779-27.487-61.26-61.265-61.26zm0 119.715c-32.23 0-58.453-26.223-58.453-58.455 0-32.23 26.222-58.451 58.453-58.451 32.229 0 58.45 26.221 58.45 58.451 0 32.232-26.221 58.455-58.45 58.455z"/></g>
                                    </svg>
                                </span>
                            </a>
                        <?php endif; ?>
                           ...
                           class="fcom_menu_button fcom_theme_button">
                            <i class="el-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2.10794 11.9954C1.93073 13.1229 2.72301 13.9055 3.69305 14.2955C7.41201 15.7908 12.5873 15.7908 16.3063 14.2955C17.2763 13.9055 18.0686 13.1229 17.8914 11.9954C17.7825 11.3024 17.244 10.7254 16.845 10.162C16.3224 9.41493 16.2705 8.60009 16.2704 7.73317C16.2704 4.38291 13.4629 1.66699 9.99968 1.66699C6.53645 1.66699 3.72895 4.38291 3.72895 7.73317C3.72887 8.60009 3.67694 9.41493 3.15435 10.162C2.75537 10.7254 2.21685 11.3024 2.10794 11.9954Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M7.5 17.5C8.16345 18.0182 9.03956 18.3333 10 18.3333C10.9604 18.3333 11.8366 18.0182 12.5 17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </i>
                            ...
                            <div class="fcom_profile_menu">
                                <div class="user_avatar">
                                    ...
                                    <span class="avatar_icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="8" width="8" viewBox="0 0 1024 1024">

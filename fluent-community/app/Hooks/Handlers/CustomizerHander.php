            ...
            if (Arr::get($vars, 'route_group') == 'admin' && Helper::isSiteAdmin()) {
                add_action('fluent_community/before_header_right_menu_items', function () {
                    ...
                    <li class="top_menu_item customizer_menu_button">
                        <button type="button" aria-label="<?php echo esc_attr__('Customize', 'fluent-community'); ?>" class="fcom_menu_button">
                ...
                $vars['js_vars']['customizerI18n'] = [
                    ...
                    'Border color of the secondary sections'                                                                                                         => __('Border color of the secondary sections', 'fluent-community'),

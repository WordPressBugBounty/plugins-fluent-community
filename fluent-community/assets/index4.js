var E=(e,s,n)=>{if(!s.has(e))throw TypeError("Cannot "+n)};var l=(e,s,n)=>(E(e,s,"read from private field"),n?n.call(e):s.get(e)),I=(e,s,n)=>{if(s.has(e))throw TypeError("Cannot add the same private member more than once");s instanceof WeakSet?s.add(e):s.set(e,n)},T=(e,s,n,t)=>(E(e,s,"write to private field"),t?t.call(e,n):s.set(e,n),n);import{d as H}from"./index6.js?ver=2.2.05";import{aZ as M,bM as N,b1 as P,a_ as S,b2 as p,as as B}from"./vendor.js?ver=2.2.05";import{g as z,j as D,s as G,d as _,l as K}from"./todoList.js?ver=2.2.05";import{y as U,R as V,z as Z,A as q,B as A,L as C,C as v,D as J,E as Q,F as W,G as X,I as F,K as Y,M as x}from"./milkdown.js?ver=2.2.05";import"./vue.js?ver=2.2.05";import"./dayjs.js?ver=2.2.05";import"./lodash.js?ver=2.2.05";const j=({ctx:e,hide:s,show:n,config:t})=>{var h,b,y,k,w;const c=N();P(()=>{c()},[n]);const o=a=>m=>{m.preventDefault(),e&&a(e),c()},i=a=>{if(!e)return!1;const m=e.get(C),{state:{doc:u,selection:$}}=m;return u.rangeHasMark($.from,$.to,a)};return S`<host>
    <button

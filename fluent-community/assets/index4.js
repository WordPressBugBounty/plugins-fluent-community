var E=(e,s,a)=>{if(!s.has(e))throw TypeError("Cannot "+a)};var l=(e,s,a)=>(E(e,s,"read from private field"),a?a.call(e):s.get(e)),I=(e,s,a)=>{if(s.has(e))throw TypeError("Cannot add the same private member more than once");s instanceof WeakSet?s.add(e):s.set(e,a)},T=(e,s,a,t)=>(E(e,s,"write to private field"),t?t.call(e,a):s.set(e,a),a);import{d as z}from"./index6.js?ver=2.7.5";import{b3 as H,bV as N,b7 as P,b4 as S,b8 as b,az as B}from"./vendor.js?ver=2.7.5";import{g as D,j as G,s as M,d as V,l as K}from"./todoList.js?ver=2.7.5";import{y as U,R as _,z as q,A as J,B as A,L as C,C as v,D as Q,E as W,F as X,G as Y,I as F,K as Z,M as x}from"./milkdown.js?ver=2.7.5";import"./vue.js?ver=2.7.5";import"./dayjs.js?ver=2.7.5";import"./lodash.js?ver=2.7.5";const j=({ctx:e,hide:s,show:a,config:t})=>{var h,p,y,k,w;const c=N();P(()=>{c()},[a]);const n=o=>m=>{m.preventDefault(),e&&o(e),c()},i=o=>{if(!e)return!1;const m=e.get(C),{state:{doc:u,selection:$}}=m;return u.rangeHasMark($.from,$.to,o)};return S`<host>
    <button
